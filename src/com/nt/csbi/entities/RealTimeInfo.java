...
public class RealTimeInfo {
	...
	private String detectionIdDetail;
	...
	public String getDetectionIdDetail() {
		return detectionIdDetail;
	}
	public void setDetectionIdDetail(String detectionIdDetail) {
		this.detectionIdDetail = detectionIdDetail;
	}
	...
	public String toString() {
		return "RealTimeInfo [recordTime=" + recordTime + ", AT=" + AT + ", BT=" + BT + ", CT=" + CT + ", DT=" + DT
				+ ", ET=" + ET + ", AF=" + AF + ", AG=" + AG + ", O2=" + O2 + ", angleX=" + angleX + ", angleY="
				+ angleY + ", angleZ=" + angleZ + ", DIST=" + DIST + ", CONT=" + CONT + ", DISRH=" + DISRH + ", NOISE="
				+ NOISE + ", INNOIS=" + INNOIS + ", OUTNOI=" + OUTNOI + ", FLOW=" + FLOW + ", power=" + power
				+ ", inputDate=" + inputDate + ", inspectedId=" + inspectedId + ", detectionId=" + detectionId + "]";
	}
